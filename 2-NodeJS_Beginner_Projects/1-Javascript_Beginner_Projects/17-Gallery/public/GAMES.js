    ...
    PC: [
      {
        ...
        pc: true,
        description:
          "Mount & Blade II: Bannerlord is a strategy action role-playing video game developed and published by TaleWorlds Entertainment, and co-published by Prime Matter. It is a prequel to Mount & Blade: Warband, a stand-alone expansion for the 2008 game Mount & Blade.",
      },
      {
        id: 1,
        name: "Skyrim",
      ...
      },
      {
        ...
        pc: true,
        description:
          "Hades is a roguelike action dungeon crawler video game developed and published by Supergiant Games. It was released for Microsoft Windows, macOS, and Nintendo Switch in September 2020, which followed an early access release in December 2018.",
      },
      {
        id: 4,
        name: "GTA V",
